...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2019/09/22 15:32:15 by ksulaima          #+#    #+#              #
#    Updated: 2019/10/11 22:10:48 by ksulaima         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
ft_strlcat.c ft_strlen.c ft_strncat.c ft_strncpy.c \
ft_strchr.c ft_strrchr.c ft_strstr.c ft_strnstr.c \
ft_strcmp.c ft_strncmp.c ft_isalpha.c ft_isdigit.c \
...
ft_putendl_fd.c ft_putnbr_fd.c ft_itoa.c ft_strsplit.c \
ft_numlen.c ft_lstnew.c ft_lstdelone.c ft_lstdel.c \
ft_lstadd.c ft_lstiter.c ft_lstmap.c ft_wordcount.c \
ft_swap.c ft_strrev.c ft_iswhitespace.c

OBJ=ft_atoi.o ft_strcat.o ft_strcpy.o ft_strdup.o \
ft_strlcat.o ft_strlen.o ft_strncat.o ft_strncpy.o \
ft_strchr.o ft_strrchr.o ft_strstr.o ft_strnstr.o \
ft_strcmp.o ft_strncmp.o ft_isalpha.o ft_isdigit.o \
ft_isalnum.o ft_isascii.o ft_isprint.o ft_toupper.o \
ft_tolower.o ft_memset.o ft_bzero.o ft_memcpy.o \
...
ft_strjoin.o ft_strtrim.o ft_putchar.o ft_putstr.o \
ft_putendl.o ft_putnbr.o ft_putchar_fd.o ft_putstr_fd.o \
ft_putendl_fd.o ft_putnbr_fd.o ft_itoa.o ft_strsplit.o \
ft_numlen.o ft_lstnew.o ft_lstdelone.o ft_lstdel.o \
ft_lstadd.o ft_lstiter.o ft_lstmap.o ft_wordcount.o \
ft_swap.o ft_strrev.o ft_iswhitespace.o
